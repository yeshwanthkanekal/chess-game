...
if(cr1[0].id == 'k'){yes1 = 'n';}
if(cr1[0].id == 'kb'){yes2 = r1;}
cr1[1].id = 2;
}}
if(yes1 == 'y'){window.location.href = 'blackwin.html';}
}
function strspl(stri){
    res = stri.split('');
    res1 = res;
    res1[0] = 9-res[0];
...
if(idc == 'pb'){ye = 0;
  res2 = idp.split('');
   if(res2[0] != 1){
    ...
    if( cr[0].id == 'p' || cr[0].id == 'b' || cr[0].id == 'r' || cr[0].id == 'n' || cr[0].id == 'q' || cr[0].id == 'k'){
...
if(idc == 'bb' || idc == 'qb'){
if(idc == 'bb'){var arr = [-1,1,-1,-1,1,-1,1,1];t = 8;}
...
cr = document.getElementById(String(res2[0])+String(res2[1])).childNodes;
 ...
 if( cr[0].id == 2){
     document.getElementById(String(res2[0])+String(res2[1])).style.background = 'green';
     cr[1].id = 5;}
 if( cr[0].id == 'pb' || cr[0].id == 'bb' || cr[0].id == 'rb' || cr[0].id == 'nb' || cr[0].id == 'qb' || cr[0].id == 'kb'){break;}
 }
else{break;}
         }}
  }
...
if(s && susp){if( c[0].id == 'pb' || c[0].id == 'bb' || c[0].id == 'rb' || c[0].id == 'nb' || c[0].id == 'qb' || c[0].id == 'kb'){
movepiece(v,c[0].id);
r  = v; s = 0; }
...
function func1() {
    ...
    ajax.onreadystatechange = function() {
        if (ajax.readyState == 4) {
            if (ajax.responseText == 'Successful') {
               ...
               susp = 1;
                cr2 = document.getElementById(yes2).childNodes;
               if(cr2[0].id != 'kb'){window.location.href = 'whitewin.html';}
            }
            else{
    ...
    ajax.open('GET', 'chesswin1.php?x=2', true); //Use POST to avoid caching
    ajax.send();
}}
changec();
}
...
if($x == 4 && $y == 4){
echo "<img src='images/pawn.png' id='pb' >";
}
if($x == 1 || $x == 8){
if($y == 1 || $y == 8){echo "<img src='images/rook"; if($x == 8){echo "b";} echo ".png' ";if($x == 1){echo "id='r'";}else {echo "id='rb'";} echo ">";}
if($y == 2 || $y == 7){echo "<img src='images/knight"; if($x == 8){echo "b";} echo ".png' ";if($x == 1){echo "id='n'";}else {echo "id='nb'";} echo ">";}
if($y == 3 || $y == 6){echo "<img src='images/bishop"; if($x == 8){echo "b";} echo ".png' ";if($x == 1){echo "id='b'";}else {echo "id='bb'";} echo ">";}
if($y == 4 ){echo "<img src='images/queen"; if($x == 8){echo "b";} echo ".png' ";if($x == 1){echo "id='q'";}else {echo "id='qb'";} echo ">";}
if($y == 5){echo "<img src='images/king"; if($x == 8){echo "b";} echo ".png' ";if($x == 1){echo "id='k'";}else {echo "id='kb'";} echo ">";}
}
...
echo "
<h1 id='announcement'>hello</h1>
<script>
myfunc('44');
myfunc('34');
document.getElementById('34').innerHTML = '<p id=2 ></p><p id=2 ></p>';
</script>
</body>
</html>";
?>
